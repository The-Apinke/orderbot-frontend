...
class Star {
  ...
  render(p, c) {
    ...
    if (dp < 0.3) {
      ...
      screenX = c.lerp(baseX, spiralPos.x + targetDist * Math.cos(spiralAngle), fin)
      screenY = c.lerp(baseY, spiralPos.y + targetDist * Math.sin(spiralAngle), fin)
    }
    ...
    c.showProjectedDot(position, 8.5 * this.strokeWeightFactor * sizeMult)
  }
}
